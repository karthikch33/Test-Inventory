            ...
            <div className="container-fluid">
                ...
                >
                    <form onSubmit={formik?.handleSubmit} className="max-w-[300px] mx-auto">
                        ...
                        <label htmlFor="description_create" className="col-12 form-label mt-3" >Description <span className='text-danger'>*</span></label>

                        <TextArea name='project_description_create' value={formik?.values?.project_description_create}
                            rows={6}
                            onChange={formik?.handleChange} disabled={false} type="text"
                            touched={formik?.touched?.project_description_create} error={formik?.errors?.project_description_create} blur={formik?.handleBlur} />

                        <div className="error">
                            {formik?.touched?.project_description_create && formik?.errors?.project_description_create}
                        </div>

                        <Space className='mt-3 d-flex justify-content-end ant-modal-footer'>
                ...
                >
                      <p className='delete-text'>Are you sure you want to delete {selectedRecord?.project_name !== undefined ? <strong style={{ color: "red", display: "inline" }}>"{` `} {selectedRecord?.project_name}{` `} "</strong> : ''} {` `}Project ? </p>
                    <p className='note-text'><strong>Note:</strong> This action will permanently delete the project, and it cannot be recovered afterward. Are you certain you want to continue?</p>
                </Modal>
