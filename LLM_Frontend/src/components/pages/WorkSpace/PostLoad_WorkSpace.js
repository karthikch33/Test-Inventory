...
const PostLoad_WorkSpace = () => {
  ...
  return (
    ...
    <div>
        ...
        <Form.Item>
        <label style={{ color: "skyblue", fontSize: "20px",marginRight:"20px",marginLeft:"10px" }}>PostLoad</label> 
        </Form.Item>
        ...
        {/* <Form.Item>
         <Search placeholder="Search Here.."
            ...
            style={{width:"270px"}} /> 
             ...
             <div className='row' style={{ height: "77.5vh",width:"100vw",marginTop:"10px",overflow : "auto"}}>
            <Table 
